import{h as d,j as _,k as p,aj as h,c as m,ak as u,m as n,al as t,am as o,z as s,F as f,an as g,ao as v,ap as x,q as l,aq as y,ar as k,n as b,as as N,at as w,_ as P}from"./nav-a3a45349.js";import{N as j}from"./NoteDisplay-017797cc.js";import{u as S}from"./index-f363c79d.js";const V={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},z={class:"opacity-50"},B={class:"text-lg"},C={class:"font-bold flex gap-2"},D={class:"opacity-50"},H=t("div",{class:"flex-auto"},null,-1),q={key:0,class:"border-gray-400/50 mb-8"},F=d({__name:"PresenterPrint",setup(M){_(p),h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
